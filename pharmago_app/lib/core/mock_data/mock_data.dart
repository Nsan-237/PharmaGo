...
// ─────────────────────────────────────────────────────────────────────────────
// Mock Data Collections (Balanced Yaoundé & Douala Pharmacies)
// ─────────────────────────────────────────────────────────────────────────────

const mockPharmacies = [
  // ── 5 Yaoundé Pharmacies (Including Pharmacie Don Bosco) ──
  PharmacyModel(
    id: 'ph-y1',
    name: 'Pharmacie Don Bosco',
    address: 'Carrefour Don Bosco, Mimboman',
    city: 'Yaoundé',
    phone: '+237 222 21 45 60',
    rating: 4.8,
    reviewCount: 142,
    distanceKm: 0.5,
    isOnDuty: true,
    ...
    website: 'www.pharmaciedonbosco.cm',
  ),
  PharmacyModel(
    id: 'ph-y2',
    ...
    website: 'www.pharmaciesainteclaire.cm',
  ),
  PharmacyModel(
    id: 'ph-y3',
    ...
    website: 'www.pharmaciecentrale-yde.cm',
  ),
  PharmacyModel(
    id: 'ph-y4',
    ...
    website: 'www.pharmacie-omnisports.cm',
  ),
  PharmacyModel(
    id: 'ph-y5',
    ...
    inStockUnits: 14,
    deliveryTimeRange: '30 - 40 min',
    website: 'www.pharmaciedumfoundi.cm',
  ),
  ...
  PharmacyModel(
    ...
    inStockUnits: 16,
    deliveryTimeRange: '20 - 30 min',
    website: 'www.pharmacieducentre-dla.cm',
  ),
  PharmacyModel(
    id: 'ph-d2',
    ...
    inStockUnits: 25,
    deliveryTimeRange: '25 - 35 min',
    website: 'www.pharmacie-johnson.cm',
  ),
  PharmacyModel(
    id: 'ph-d3',
    ...
    city: 'Douala',
    phone: '+237 233 42 66 30',
    rating: 4.5,
    reviewCount: 88,
    distanceKm: 1.4,
    isOnDuty: false,
    isOpen: true,
    openingHours: 'Open • Closes at 7:30 PM',
    inStockUnits: 10,
    deliveryTimeRange: '30 - 45 min',
    website: 'www.pharmaciedelacote.cm',
  ),
  PharmacyModel(
    id: 'ph-d4',
    ...
    inStockUnits: 12,
    deliveryTimeRange: '35 - 45 min',
    website: 'www.pharmaciedesnations.cm',
  ),
  PharmacyModel(
    id: 'ph-d5',
    ...
    website: 'www.pharmaciestetherese.cm',
  ),
];
